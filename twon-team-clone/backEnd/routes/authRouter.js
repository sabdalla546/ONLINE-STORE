...
router. 
    route('/').get(authController.protect,authController.isAdmin,userController.getAllUsers);
router. 
    route('/createUserorAdmin').post(authController.protect,authController.isSuberAdmin,authController.createUserOrAdmin);
